...
%     y_per_3 = y_3 / size(2);
%     
%     x_index_1 = int8(l - x_per_1 * l + 1)
%     
%     if x_index_1 < 1
%         x_index_1 = 1;
%     end
%     
%     y_index_1 = int8(l - y_per_1 * l + 1)
%     
%     if y_index_1 < 1
%         y_index_1 = 1;
%     end
%     
%     x_index_2 = int8(l - x_per_2 * l + 1)
%     
%     if x_index_2 < 1
%         x_index_2 = 1;
%     end
%     
%     y_index_2 = int8(l - y_per_2 * l + 1)
%     
%     if y_index_2 < 1
%         y_index_2 = 1;
%     end
%     
%     x_index_3 = int8(l - x_per_3 * l + 1)
%     
%     if x_index_3 < 1
%         x_index_3 = 1;
%     end
%     
%     y_index_3 = int8(l - y_per_3 * l + 1)
%     
%     if y_index_3 < 1
%         y_index_3 = 1;
%     end
